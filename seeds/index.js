...
Template_Model.insertMany([
  {
    ...
    content: [
      {
        en: "<!DOCTYPE html><html> <head> <title>Subscription Unsuccessful</title> </head> <body>Hi  {{firstName}}, Your subscription to plan  {{planName}}was unsuccessful. Please try again later. <br> Thank you </body></html>",
      },
      {
        fr: "<!DOCTYPE html><html> <head> <title>Subscription Unsuccessful</title> </head> <body>Hi  {{firstName}}, Your subscription to plan  {{planName}}was unsuccessful. Please try again later. <br> Thank you </body></html>",
      },
    ],
  ...
  },
  {
    ...
    content: [
      {
        en: "<!DOCTYPE html><html> <head> <title>Subscription Successful</title> </head> <body>Hi  {{firstName}}, Your subscription to plan  {{planName}}was successful. <br> Thank you </body></html>",
      },
      {
        fr: "<!DOCTYPE html><html> <head> <title>Subscription Successful</title> </head> <body>Hi  {{firstName}}, Your subscription to plan  {{planName}}was successful. <br> Thank you </body></html>",
      },
    ],
  ...
  },
  {
    variables: {
      subject: [],
      content: ["name", "supplierName", "Category", "Country"],
    },
    subject: [
      {
  ...
  },
  {
    ...
    content: [
      {
        en: "<!DOCTYPE html><html> <head> <title>Cancel Subscription Unsuccessful</title> </head> <body>Hi  {{firstName}}, cancellation of subscription to plan  {{planName}}was unsuccessful. Please try again later. <br> Thank you </body></html>",
      },
      {
        fr: "<!DOCTYPE html><html> <head> <title>Cancel Subscription Unsuccessful</title> </head> <body>Hi  {{firstName}}, cancellation of subscription to plan  {{planName}}was unsuccessful. Please try again later. <br> Thank you </body></html>",
      },
    ],
  ...
  },
  {
    ...
    content: [
      {
        en: "<!DOCTYPE html><html><body><p>Hello, {{first_name}}</p><p>Your custom domain has been verified.</p><p><br></p><p>Enjoy!</p><p>The App team</p></body></html>",
      },
      {
        fr: "<!DOCTYPE html><html><body><p>Hello, {{first_name}}</p><p>Your custom domain has been verified.</p><p><br></p><p>Enjoy!</p><p>The App team</p></body></html>",
      },
    ],
  ...
  },
  {
    ...
    content: [
      {
        en: "<!DOCTYPE html><html><body><p>Hello, {{first_name}}</p><p>Your custom domain verification has failed.</p><p><br></p><p>Enjoy!</p><p>The App team</p></body></html>",
      },
      {
        fr: "<!DOCTYPE html><html><body><p>Hello, {{first_name}}</p><p>Your custom domain verification has failed.</p><p><br></p><p>Enjoy!</p><p>The App team</p></body></html>",
      },
    ],
  ...
  },
  {
    ...
    content: [
      {
        en: "<!DOCTYPE html><html><body> <p>Your meeting request is successfully sent to the exhibitor {{company}}. As soon as the exhibitor responds, you will receive outcome via email. LOG IN your dashboard and manage meetings.</p><p>Timeline: 1 day before meeting</p><p>GO TO DASHBOARD</p><p>Your Meeting Request Details.</p><p>Exhibitor Name</p><p>Category</p><p>Meeting Date</p><p>Meeting Time</p><p><span style='font-size:14pt;color:#ff0000;'>Duration</span><span>-30minutes</span></p><p>Exhibition</p><p>Venue</p><p>Booth Number</p><p>Get To Know {{supplierName}}Better Product From {{supplierName}},</p><p>Before the meeting explore the supplier profile, products and know more about what the suppliers can offer. Enquiry information about the products and organize sample inspections at the expo.</p><p>VISIT SUPPLIER PROFILE</span></p></body></html>",
      },
      {
        fr: "<!DOCTYPE html><html><body> <p>Your meeting request is successfully sent to the exhibitor {{company}}. As soon as the exhibitor responds, you will receive outcome via email. LOG IN your dashboard and manage meetings.</p><p>Timeline: 1 day before meeting</p><p>GO TO DASHBOARD</p><p>Your Meeting Request Details.</p><p>Exhibitor Name</p><p>Category</p><p>Meeting Date</p><p>Meeting Time</p><p><span style='font-size:14pt;color:#ff0000;'>Duration</span><span>-30minutes</span></p><p>Exhibition</p><p>Venue</p><p>Booth Number</p><p>Get To Know {{supplierName}}Better Product From {{supplierName}},</p><p>Before the meeting explore the supplier profile, products and know more about what the suppliers can offer. Enquiry information about the products and organize sample inspections at the expo.</p><p>VISIT SUPPLIER PROFILE</span></p></body></html>",
      },
    ],
  ...
  },
  {
    ...
    content: [
      {
        en: "<!DOCTYPE html><html><body> <p>Your meeting request is successfully sent to the exhibitor {{company}}. As soon as the exhibitor responds, you will receive outcome via email. LOG IN your dashboard and manage meetings.</p><p>Timeline: 30 minutes before meeting</p><p>GO TO DASHBOARD</p><p>Your Meeting Request Details.</p><p>Exhibitor Name</p><p>Category</p><p>Meeting Date</p><p>Meeting Time</p><p><span style='font-size:14pt;color:#ff0000;'>Duration</span><span>-30minutes</span></p><p>Exhibition</p><p>Venue</p><p>Booth Number</p><p>Get To Know {{supplierName}}Better Product From {{supplierName}},</p><p>Before the meeting explore the supplier profile, products and know more about what the suppliers can offer. Enquiry information about the products and organize sample inspections at the expo.</p><p>VISIT SUPPLIER PROFILE</span></p></body></html>",
      },
      {
        fr: "<!DOCTYPE html><html><body> <p>Your meeting request is successfully sent to the exhibitor {{company}}. As soon as the exhibitor responds, you will receive outcome via email. LOG IN your dashboard and manage meetings.</p><p>Timeline: 30 minutes before meeting</p><p>GO TO DASHBOARD</p><p>Your Meeting Request Details.</p><p>Exhibitor Name</p><p>Category</p><p>Meeting Date</p><p>Meeting Time</p><p><span style='font-size:14pt;color:#ff0000;'>Duration</span><span>-30minutes</span></p><p>Exhibition</p><p>Venue</p><p>Booth Number</p><p>Get To Know {{supplierName}}Better Product From {{supplierName}},</p><p>Before the meeting explore the supplier profile, products and know more about what the suppliers can offer. Enquiry information about the products and organize sample inspections at the expo.</p><p>VISIT SUPPLIER PROFILE</span></p></body></html>",
      },
    ],
  ...
  },
  {
    ...
    content: [
      {
        en: "<!DOCTYPE html><html><body> <p>Your meeting request is successfully sent to the exhibitor {{company}}. As soon as the exhibitor responds, you will receive outcome via email. LOG IN your dashboard and manage meetings.</p><p>Timeline: 10 minutes before meeting</p><p>GO TO DASHBOARD</p><p>Your Meeting Request Details.</p><p>Exhibitor Name</p><p>Category</p><p>Meeting Date</p><p>Meeting Time</p><p><span style='font-size:14pt;color:#ff0000;'>Duration</span><span>-30minutes</span></p><p>Exhibition</p><p>Venue</p><p>Booth Number</p><p>Get To Know {{supplierName}}Better Product From {{supplierName}},</p><p>Before the meeting explore the supplier profile, products and know more about what the suppliers can offer. Enquiry information about the products and organize sample inspections at the expo.</p><p>VISIT SUPPLIER PROFILE</span></p></body></html>",
      },
      {
        fr: "<!DOCTYPE html><html><body> <p>Your meeting request is successfully sent to the exhibitor {{company}}. As soon as the exhibitor responds, you will receive outcome via email. LOG IN your dashboard and manage meetings.</p><p>Timeline: 10 minutes before meeting</p><p>GO TO DASHBOARD</p><p>Your Meeting Request Details.</p><p>Exhibitor Name</p><p>Category</p><p>Meeting Date</p><p>Meeting Time</p><p><span style='font-size:14pt;color:#ff0000;'>Duration</span><span>-30minutes</span></p><p>Exhibition</p><p>Venue</p><p>Booth Number</p><p>Get To Know {{supplierName}}Better Product From {{supplierName}},</p><p>Before the meeting explore the supplier profile, products and know more about what the suppliers can offer. Enquiry information about the products and organize sample inspections at the expo.</p><p>VISIT SUPPLIER PROFILE</span></p></body></html>",
      },
    ],
  ...
  },
  {
    ...
    content: [
      {
        en: "<!DOCTYPE html><html><p>Hello {{name}}</p><p>Thank you for sourcing on {{event_site}}. Based on the items you recently viewed, we put together a selection of recommended products just for you.</p><p><strong>POPULAR SUPPLIERS</strong></p><p>BEST MATCHING SUPPLIERS</p><p>SET UP MEETINGS, CONNECT, CALL, OR CHAT</p><p> {{supplierName}}</p><p> {{category}}</p><p> {{country}}</p><p><a href=' {{action_link}}'>View</a> Profile</p></html>",
      },
      {
