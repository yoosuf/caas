      ...
      chai
        ...
        .end((err, res) => {
          ...
          res.body.should.have
            .property("message")
            .eql("You have been logged in successfully");
          ...
          chai
            ...
            .end((err, res) => {
              ...
              res.body.data[0].should.have
                .property("msg")
                .eql("johndoe@gmail.comalready exists, please choose another");
              res.body.should.have
                .property("message")
                .eql("Something went wrong, please try again later");
              done();
            });
        })
        ...
        .then(function (document) {
          chai
            ...
            .end((err, res) => {
              ...
              res.body.should.have
                .property("message")
                .eql("Account has been deleted successfully");
        ...
        .then(function (document) {
          chai
            ...
            .end((err, res) => {
              ...
              res.body.should.have
                .property("message")
                .eql("Account has been updated successfully");
              res.body.should.have.property("type").eql("success");
              res.body.data.should.have
                .property("email")
                .eql("johndoexx@gmail.com");
              done();
            });
        })
        .catch(function (error) {
