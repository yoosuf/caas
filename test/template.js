      ...
      chai
        ...
        .end((err, res) => {
          ...
          res.body.should.have
            .property("message")
            .eql("Template has been added successfully");
        ...
        .then(function (document) {
          chai
            ...
            .end((err, res) => {
              ...
              res.body.should.have
                .property("message")
                .eql("Template has been deleted successfully");
        ...
        .then(function (document) {
          chai
            ...
            .end((err, res) => {
              ...
              res.body.should.have
                .property("message")
                .eql("Template has been updated successfully");
              res.body.should.have.property("type").eql("success");
              res.body.data.should.have.property("type").eql("app-x");
              done();
            });
        })
        .catch(function (error) {
